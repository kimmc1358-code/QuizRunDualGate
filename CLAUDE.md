...
from the card, because those two plates do not grow when the card does. Its
rim is opaque and as wide as the card art's white border, because a
translucent veil leaves white reading as a bright ring (254 through the veil
is still 117 against an interior of 70).
